...
export const Topbar = () => {
    ...
    return (
        <HStack minH='60px' w='full' justifyContent='center' bg='linear-gradient(to right, #7f00ff, #e100ff)' boxShadow='sm' position='sticky' top='0' zIndex='999'>
            <HStack w='full' maxW='6xl' px='4' color='white' justifyContent='space-between'>
                <HStack>
                    <MenuMobile />
                    <Link href='/'>
