        ...
        >
            ...
            <Stack w='full'>
                ...
                <HStack w='full' justifyContent='space-between'>
                    <Text fontWeight='700' color='red.500' fontSize='18px'>1.800.555 đ</Text>
                    <Text fontWeight='700' fontSize='14px' opacity='0.5' textDecoration='line-through'>1.800.555 đ</Text>
                </HStack>
